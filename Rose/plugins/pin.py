...
@app.on_message(command("تثبيت") & admin_filter )
@language
...
@app.on_message(command("الغاء تثبيت") & admin_filter)
@language
...
@app.on_message(command("الغاء تثبيت الكل") & admin_filter)
@language
...
@app.on_message(command("المثبت") & admin_filter )
@language
...
@app.on_message(command("مسح الروابط") & admin_filter )
@language
